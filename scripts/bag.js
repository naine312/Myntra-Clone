...
function loadBagItemObjects() {
  ...
  function removeFromBag(ietmId)
  {
    bagItems  = bagItems.filter(bagItemId=>  bagItemId !=ietmId); 
...
function displayBagSummery()
{
    ...
    let fee = bagItemObjects.length>0?99:0; 
    let finalPayment = totalMRP - totalDiscount +fee ;  
